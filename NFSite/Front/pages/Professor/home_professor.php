...
<head>
    <meta charset="UTF-8" />
    <title>Login Professor - New Football</title>
    ...
    <style>
        * { box-sizing: border-box; }
        ...
        .btn-aluno { background-color: #4b0082; color: #ffd700; }
        .btn-aluno:hover { background-color: #6a1aa0; color: #fff; }
        ...
        @media (max-width: 480px) {
            ...
            button[type="submit"], .btn-group button { font-size: 1rem; padding: 12px 0; }
        }
    </style>
</head>
<body>
...
<div class="login-container">
    ...
    <form action="validar_login_professor.php" method="POST">
