<?php
session_start();
include '../../../Back/conexao.php'; // Corrigido para o caminho correto
...
// Apaga jogos anteriores à data atual
...
if (isset($_GET['excluir'])) {
    $id = $_GET['excluir'];
    $stmt = $conn->prepare("DELETE FROM jogos WHERE id = ? AND professor_id = ?");
